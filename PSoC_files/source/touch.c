...
void touch_process(void *arg)
{
    ...
    while (1)
    {
        ...
        touch_current_state.slider_status = (slider_touch_info->numPosition > 0); // @suppress("Field cannot be resolved")
        touch_current_state.slider_pos = slider_touch_info->ptrPosition->x; // @suppress("Field cannot be resolved")
